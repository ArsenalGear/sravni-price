...
<main>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumbs__wrapper">
                        <span class="breadcrumbs__link breadcrumbs__link-last">Поиск</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="title-goods">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="title-goods__title">Результаты поиска по запросу {{\request('query')}}</h1>
                </div>
                <div class="col-12">
                    ...
                    <ul class="filter">
                        <li class="filter__goods">
                            <div class="filter__link-block">
                                <a class="filter__link active" href="#" title="результаты поиска">Результаты поиска</a>
                        ...
                        @foreach ($categories as $subcat)
                            <li class="filter__goods">
                                <div class="filter__link-block">
                                    <a class="filter__link" href="/catalog/{{$subcat->getAttribute('path')}}" title="{{$subcat->name}}">{{$subcat->name}}
                                        <span class="filter__amount-block">
                                            <span class="filter__left-bracker">(</span>
